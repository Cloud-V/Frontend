	...
	render() {
		return (
			<AppFooter className="landing-footer">
				<span><a href="https://cloudv.io">Cloud V</a> &copy; 2018</span>
				<div className="ml-auto">
					<Link className="mr-4" to="/tools">Tools</Link>
					<Link className="mr-4" to="/privacy">Privacy Policy</Link>
					<Link className="mr-4" to="/terms">Terms of Service</Link>
