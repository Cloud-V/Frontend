...
var TreeNode = (function(_React$Component) {
	...
	function TreeNode(props) {
		...
		var _this = (0, _possibleConstructorReturn3["default"])(
			this,
			(TreeNode.__proto__ || Object.getPrototypeOf(TreeNode)).call(
				this,
				props
			)
		);
	...
	(0, _createClass3["default"])(TreeNode, [
		...
		},
		{
			...
			value: function render() {
				...
				var dataOrAriaAttributeProps = (0, _util.getDataAndAria)(
					otherProps
				);
...
TreeNode.propTypes = {
	...
	switcherIcon: _propTypes2["default"].oneOfType([
		_propTypes2["default"].node,
		_propTypes2["default"].func
	])
};
...
var _initialiseProps = function _initialiseProps() {
	...
	this.getNodeChildren = function() {
		...
		var originList = (0, _toArray2["default"])(children).filter(function(
			node
		) {
			return node;
		});
	...
	this.renderSwitcher = function() {
		...
		var switcherCls = (0, _classnames2["default"])(
			prefixCls + "-switcher",
	...
	this.renderIcon = function() {
		...
		return _react2["default"].createElement("span", {
			className: (0, _classnames2["default"])(
				prefixCls + "-iconEle",
				prefixCls + "-icon__" + (_this2.getNodeState() || "docu"),
	...
	this.renderSelector = function() {
		...
		return _react2["default"].createElement(
			"span",
			{
				...
				className: (0, _classnames2["default"])(
					"" + wrapClass,
					wrapClass + "-" + (_this2.getNodeState() || "normal"),
					!disabled &&
