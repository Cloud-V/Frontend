	...
	function Tree() {
		...
		return (
			(_ret = ((_temp = ((_this = _possibleConstructorReturn(
				this,
				(_ref =
					Tree.__proto__ || Object.getPrototypeOf(Tree)).call.apply(
					_ref,
					[this].concat(args)
				)
			)),
			...
			(_this.onNodeDragEnter = function(event, node) {
				...
				if (
					_this.dragNode.props.eventKey === eventKey &&
					dropPosition === 0
				) {
					_this.setState({
						dragOverNodeKey: "",
				...
				setTimeout(function() {
					...
					Object.keys(_this.delayedDragEnterLogic).forEach(function(
						key
					) {
			...
			(_this.onNodeDragOver = function(event, node) {
				...
				if (
					_this.dragNode &&
					eventKey === _this.state.dragOverNodeKey
				) {
					var dropPosition = calcDropPosition(event, node);
			...
			(_this.onNodeDrop = function(event, node) {
				var _this$state = _this.state,
					...
					dragNodesKeys =
						_this$state$dragNodes === undefined
							? []
							: _this$state$dragNodes,
			...
			(_this.onNodeSelect = function(e, treeNode) {
				...
				const isControlPressed = e.nativeEvent.ctrlKey;
				const isShiftPressed = e.nativeEvent.shiftKey;

				// Update selected keys
				if (!targetSelected) {
					if (multiple && (isControlPressed || isShiftPressed)) {
				...
				} else if (!multiple || !(isControlPressed || isShiftPressed)) {
					selectedKeys = [eventKey];
				} else {
				...
				return new Promise(function(resolve) {
					...
					_this.setState(function(_ref2) {
						var _ref2$loadedKeys = _ref2.loadedKeys,
							loadedKeys =
								_ref2$loadedKeys === undefined
									? []
									: _ref2$loadedKeys,
							_ref2$loadingKeys = _ref2.loadingKeys,
							loadingKeys =
								_ref2$loadingKeys === undefined
									? []
									: _ref2$loadingKeys;
						...
						promise.then(function() {
							...
							var newLoadingKeys = arrDel(
								_this.state.loadingKeys,
								eventKey
							);
			...
			(_this.isKeyChecked = function(key) {
				var _this$state$checkedKe = _this.state.checkedKeys,
					checkedKeys =
						_this$state$checkedKe === undefined
							? []
			...
			(_this.renderTreeNode = function(child, index) {
				var renameNode = _this.props.renameNode || "";
				var onNodeRename = _this.props.onNodeRename || (() => null);
				var renameNodeTitle = _this.props.renameNodeTitle || "";
				var onNodeRenameChange =
					_this.props.onNodeRenameChange || (() => null);
				var level =
				...
				var _this$state3 = _this.state,
					...
					expandedKeys =
						_this$state3$expanded === undefined
							? []
							: _this$state3$expanded,
					_this$state3$selected = _this$state3.selectedKeys,
					selectedKeys =
						_this$state3$selected === undefined
							? []
							: _this$state3$selected,
					_this$state3$halfChec = _this$state3.halfCheckedKeys,
					halfCheckedKeys =
						_this$state3$halfChec === undefined
							? []
							: _this$state3$halfChec,
					_this$state3$loadedKe = _this$state3.loadedKeys,
					loadedKeys =
						_this$state3$loadedKe === undefined
							? []
							: _this$state3$loadedKe,
					_this$state3$loadingK = _this$state3.loadingKeys,
					loadingKeys =
						_this$state3$loadingK === undefined
							? []
							: _this$state3$loadingK,
				...
				return React.cloneElement(child, {
					...
					pos: pos,
					rename: renameNode === key,
					onNodeRename: onNodeRename,
					renameTitle: renameNodeTitle,
					onRenameChange: onNodeRenameChange,
					// [Legacy] Drag props
					dragOver: dragOverNodeKey === key && dropPosition === 0,
					dragOverGapTop:
						dragOverNodeKey === key && dropPosition === -1,
					dragOverGapBottom:
						dragOverNodeKey === key && dropPosition === 1
				});
			}),
			...
			},
			{
				...
				value: function render() {
					...
					var _props2 = this.props,
						...
						tabIndex =
							_props2$tabIndex === undefined
								? 0
								: _props2$tabIndex;
					var onKeyPress = _props2.onKeyPress;
						...
						if (checkedKeyEntity) {
							var _checkedKeyEntity = checkedKeyEntity,
								_checkedKeyEntity$che =
									_checkedKeyEntity.checkedKeys,
								checkedKeys =
									_checkedKeyEntity$che === undefined
										? []
										: _checkedKeyEntity$che,
								_checkedKeyEntity$hal =
									_checkedKeyEntity.halfCheckedKeys,
								halfCheckedKeys =
									_checkedKeyEntity$hal === undefined
										? []
										: _checkedKeyEntity$hal;
