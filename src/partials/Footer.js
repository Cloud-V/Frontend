		...
		return (
			<AppFooter className="d-flex justify-content-between">
				<Col md="auto" className="footer-copyright">
					<span>
						&copy; 2014-{new Date().getFullYear()} <a target="_blank" rel="noopener noreferrer" href="https://aucegypt.edu">The American University in Cairo</a> and the Cloud V Project. All rights reserved.
					</span>
				</Col>
