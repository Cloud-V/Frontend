		...
		return (
			<Form className="auth-form pb-0" onSubmit={handleSubmit}>
				...
				<div className="w-100 d-flex justify-content-between align-items-center">
					<Button type="submit" className="action-button mr-2" disabled={submitting}>Save</Button>
					<Button className="action-button action-button-secondary mr-2" onClick={this.props.onCancel} disabled={submitting}>Cancel</Button>
					<Button className="action-button danger-button d-flex justify-content-center align-items-center" onClick={this.props.onRepositoryDelete} disabled={submitting}><i className="fa fa-trash fa-lg mr-2"></i>Destroy!</Button>
				</div>
			</Form>
		);
	};
