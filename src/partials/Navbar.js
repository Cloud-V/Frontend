...
const getGravatarURL = (email) => {
    let parsedEmail = "";
    if (email) parsedEmail = email.toLowerCase().split(" ").join("");
    ...
    render() {
        ...
        return (
            <React.Fragment>
                                ...
                                <AppHeaderDropdown direction="down">
                                    <DropdownToggle nav>
                                        <img
                                            ...
                                            alt={displayName}
                                        />
                                        <span className="header-greeting mr-4 d-lg-down-none">
                                            {signupComplete && (
                                                <React.Fragment>
                                                    {" "}
                                                    Hi, {displayName}
                ...
                <AppAside
                    className="cloudv-aside dashboard-aside d-md-none"
                    fixed
                    hidden
                >
                    <Nav className="">
                        <NavItem className="w-100">
                            ...
                            <NavLink className="" href="/explore">
                                Discover
                            </NavLink>
                            {!isLogged && (
                                <NavLink className="action-color" href="/login">
                                    Log in
                                </NavLink>
                            )}
                            {isLogged && (
                                <NavLink className="" href="/edit">
                                    Edit Profile
                                </NavLink>
                            )}
                            {isLogged && (
