...
const reducer = (state = initialState, action) => {
	switch (action.type) {
		...
		case generateInProgressActionTypeName(ActionNames.ADD_REPOSITORY_VERSION):
		...
		case generateInProgressActionTypeName(ActionNames.REMOVE_REPOSITORY_VERSION):
		case generateSuccessActionTypeName(ActionNames.REMOVE_REPOSITORY_VERSION):
			return createAPIReducer(state, action, {
