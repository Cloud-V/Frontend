...
const reducer = (state = initialState, action) => {
	switch (action.type) {
		...
		case generateErrorActionTypeName(ActionNames.ADD_REPOSITORY_CONTRIBUTOR):
		case generateInProgressActionTypeName(ActionNames.ADD_REPOSITORY_CONTRIBUTOR):
		case generateSuccessActionTypeName(ActionNames.ADD_REPOSITORY_CONTRIBUTOR):
		...
		case generateErrorActionTypeName(ActionNames.REMOVE_REPOSITORY_CONTRIBUTOR):
		case generateInProgressActionTypeName(ActionNames.REMOVE_REPOSITORY_CONTRIBUTOR):
		case generateSuccessActionTypeName(ActionNames.REMOVE_REPOSITORY_CONTRIBUTOR):
			return createAPIReducer(state, action, {
