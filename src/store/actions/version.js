...
export const addRepositoryVersion = ({ ownerName, repoName }, version) =>
    createAPI({
        method: "post",
        type: ActionNames.ADD_REPOSITORY_VERSION,
        params: [`/${ownerName}/${repoName}/${URLs.NewVersion}`, version],
    });
export const removeRepositoryVersion = ({ ownerName, repoName }, { _id }) =>
    createAPI({
        method: "post",
...
export const downloadVersion = ({ ownerName, repoName }, { _id }) =>
    createDownloadAPI({
