...
export const getUserRepositories = ({ ownerName }, page = 0) =>
    createAPI({
        method: "get",
...
export const getSharedRepositories = ({ ownerName }, page = 0) =>
    createAPI({
        method: "get",
...
export const getWatchingRepositories = ({ ownerName }, page = 0) =>
    createAPI({
        method: "get",
