...
import { explore as exploreRepositories } from "store/actions/explore";
...
const mapDispatchToProps = (dispatch) => {
    return {
        exploreRepositories: ({ featured, popular, latest }) =>
            dispatch(
                exploreRepositories({
                    featured,
                    popular,
...
class Search extends Component {
    ...
    render() {
        ...
        const featuredCount =
            featuredWrapper.get("pagination").get("count") || 0;
                    ...
                    <Row className="mr-0">
                        ...
                        <Col xl="10" lg="9" className="pr-0">
                            ...
                            >
                                ...
                                >
                                    <Row className="mr-0">
                                        {_.chunk(featured.toArray(), 3).map(
                                            (repos, index) => (
                                        ...
                                        <div className="w-100 d-flex justify-content-center mr-md-6 mr-sm-0">
                                            <Pagination
                                                ...
                                                handlePageClick={this.handlePageClick.bind(
                                                    this,
                                                    "featured"
                                                )}
