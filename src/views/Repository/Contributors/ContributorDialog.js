		...
		return (
			<Modal isOpen={this.props.modal} toggle={this.props.toggle} className="dialog new-repo-dialog">
				...
				<ModalBody className="modal-form">
					<div className="header d-flex justify-content-center align-items-center mb-5 mt-1">{this.props.editMode? 'Edit': 'Add'} contributor</div>
					<ContributorForm contributor={this.props.contributor}
