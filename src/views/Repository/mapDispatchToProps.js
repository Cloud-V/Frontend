...
export default dispatch => {
	return {
		...
		repositoryUpdate: ({
			ownerName,
			repoName
		}, updates) => dispatch(updateRepository({
			ownerName,
			repoName
		}, updates)),
		repositoryFilesGet: ({
		...
		repositoryContributorsGet: ({
			ownerName,
			repoName
		}) => dispatch(getRepositoryContributors({
			ownerName,
			repoName
		})),
		repositoryContributorsAdd: ({
			...
			username,
			accessLevel
		}) => dispatch(addRepositoryContributor({
			ownerName,
			repoName
		}, {
			username,
		...
		repositoryContributorsRemove: ({
			...
			username
		}) => dispatch(removeRepositoryContributor({
			ownerName,
			repoName
		}, {
			username
		...
		repositoryVersionsGet: ({
			ownerName,
			repoName
		}) => dispatch(getRepositoryVersions({
			ownerName,
			repoName
		})),
		repositoryVersionsAdd: ({
			ownerName,
			repoName
		}, version) => dispatch(addRepositoryVersion({
			ownerName,
			repoName
		}, version)),
		repositoryVersionsRemove: ({
			ownerName,
			repoName
		}, version) => dispatch(removeRepositoryVersion({
			ownerName,
			repoName
		}, version)),
		repositoryVersionsClone: ({
			ownerName,
			repoName
		}, version, target) => dispatch(cloneRepositoryVersion({
			ownerName,
			repoName
		}, version, target)),
		...
		repositoryClone: (repo, target) => dispatch(cloneRepository(repo, target)),
