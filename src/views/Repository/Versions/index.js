...
class Versions extends Component {
        ...
        this.props.setVersion(version).then((action) => {
            ...
            ReactGA.modalview(
                `/${repository.get("data").get("ownerName")}/${repository
                    .get("data")
                    .get("repoName")}/versions/clone/${version._id}`
            );
            this.setState({
                cloneModal: true,
            });
    ...
    promptRemove(version) {
        this.props.setVersion(version).then((action) => {
            ...
            ReactGA.modalview(
                `/${repository.get("data").get("ownerName")}/${repository
                    .get("data")
                    .get("repoName")}/versions/delete/${version._id}`
            );
        ...
        return _.map(this.props.versions.get("data").toJS(), (version, ind) => {
            return (
                <tr key={version._id}>
                    ...
                    <td className="col-lg-2 col-md-3 col-sm-4">
                        <Link className="nav-link user-link" to="#">
                    ...
                    <td className="col-lg-4 col-md-5 col-sm-6">
                        <Button
                            ...
                            onClick={(e) =>
                                this.props.onVersionDownload(version)
                            }
                        >
                        ...
                        <Button
                            className="repository-details-action"
                            onClick={(e) => this.promptClone(version)}
                        >
                        ...
                        <Button
                            disabled={!isWriter}
                            className="repository-details-action"
                            onClick={(e) => this.promptRemove(version)}
                        >
    ...
    render() {
        ...
        if (this.props.versions.get("status") === "loading") {
            ...
            return (
                <Alert color="danger">{this.props.versions.get("error")}</Alert>
            );
        }
        ...
        return (
            <React.Fragment>
                <VersionDialog
                    ...
                    defaultTitle={this.props.repository
                        .get("data")
                        .get("repoName")}
                ...
                <ConfirmationDialog
                    ...
                    onResponse={(confirmed) => {
                        if (confirmed) {
                            this.props
                                .onVersionRemove(this.props.version.get("data"))
                                .then((action) => {
                                    this.closeDialog();
                                })
                                .catch((err) => {
                ...
                <Table className="repository-table mb-0" responsive>
                    <thead>
                        <tr>
                            <th className="col-lg-2 col-md-3 col-sm-4">
                                Title
                            </th>
                            <th className="col-lg-2 col-md-3 col-sm-4">
                                Number
                            ...
                            <th className="repository-details-action-header col-lg-4 col-md-5 col-sm-6">
                                Possible Actions
                            </th>
                        </tr>
                    </thead>
