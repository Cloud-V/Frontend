...
class RepositoryOverview extends Component {
	...
	render() {
		...
		return (<div className="repository-detials-overview">
				<CloneDialog
						...
						<Row className="repository-detials-overview-actions-button-wrapper mr-0 ml-0 mb-sm-2">
							<Col xl="12" lg="12" md="12" sm="12">
								<Button className="d-flex justify-content-between align-items-center w-100" onClick={this.props.onRepositoryWatch}>
									<Col md="6" className="pr-0 pl-0 d-flex justify-content-center">
										<i className="mb-1 mt-1 icomoon icon-watch fa-2x mr-2"></i>
									</Col>
									<Col md="6" className="pr-0 pl-0 d-flex justify-content-start">
										{this.props.repository.get('watched')? 'Un-watch': 'Watch'}
									</Col>
								</Button>
							</Col>
							<Col xl="12" lg="12" md="12" sm="12">
								<Button className="d-flex justify-content-between align-items-center w-100" onClick={this.props.onRepositoryFavorite}>
									<Col md="6" className="pr-0 pl-0 d-flex justify-content-center">
										<i className="mb-1 mt-1 icomoon icon-star fa-2x mr-2"></i>
									</Col>
									<Col md="6" className="pr-0 pl-0 d-flex justify-content-start">
										{this.props.repository.get('favorited')? 'Un-Favorite': 'Favorite'}
									</Col>
								</Button>
							</Col>
							<Col xl="12" lg="12" md="12" sm="12">
								<Button className="d-flex justify-content-between align-items-center w-100" onClick={this.openCloneDialog}>
									<Col md="6" className="pr-0 pl-0 d-flex justify-content-center">
							...
							<Col xl="12" lg="12" md="12" sm="12">
								<Button className="d-flex justify-content-between align-items-center w-100" onClick={this.props.onRepositoryDownload}>
									<Col md="6" className="pr-0 pl-0 d-flex justify-content-center">
							...
							<div className="d-flex justify-content-between w-100">
								<div className="repository-detials-overview-details-content-stats">
									<div className="repository-detials-overview-details-content-stats-row mb-1">
										<i className="mb-1 mt-1 icomoon icon-star fa-lg md-size mr-2"></i>{favs} favorite{(favs === 1)? '': 's'}
									</div>
									<div className="repository-detials-overview-details-content-stats-row">
										<i className="mb-1 mt-1 icomoon icon-watches mr-2"></i>{watches} watcher{(watches === 1)? '': 's'}
									</div>
								</div>
								<div className="repository-detials-overview-details-content-certified">
									{certified &&
										<React.Fragment>
											...
											</i>Certified Repository
										</React.Fragment>}
									{isAdmin && <div className="repository-admin-btns mt-1">
										<Button outline className="action-button mr-2" onClick={this.props.onRepositoryFeature}>
											<i className="fa fa-star mr-2"></i>{featured? 'Un-feature': 'Feature'}
										</Button>
										<Button outline className="action-button" onClick={this.props.onRepositoryCertify}>
											<i className="fa fa-check mr-2"></i>{certified? 'Un-certify': 'Certify'}
										</Button>
									</div>}
								</div>
							</div>
