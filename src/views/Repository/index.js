...
class Repository extends Component {
  ...
  onRepositoryWatch() {
    return this.props.repositoryWatch(this.props.repository.get("data").toJS());
  }
  ...
  async componentDidMount() {
    ...
    if (this.props.repository.get("status") !== "error") {
      ...
      let steps = this.state.steps
        .concat(isWriter ? this.state.writerSteps : [])
    ...
    return (
      <div className="h-100">
        <ConfirmationDialog
          ...
          disabled={this.props.repository.get("status") === "action-loading"}
          loading={this.props.repository.get("status") === "action-loading"}
        ...
        <Joyride
          steps={steps}
          run={
            run && this.props.user.get("data").get("repositoryTour") === false
          }
        ...
        >
          ...
          <TabPane className="h-100" tab="Contributors" key="contributors">
            <Contributors
