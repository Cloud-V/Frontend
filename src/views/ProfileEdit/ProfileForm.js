...
const validate = values => {
	...
	if (!values.get('password')) {
		...
		errors.password = 'Password should have at least 8 characters and contain at least one letter and one numeral.';
	}
		...
		return (
			<Form className="profile-form w-100 pl-4 pr-4 pt-2 pb-2" onSubmit={handleSubmit}>
				...
				<div className="w-100 d-flex justify-content-between align-items-center">
					...
					<Link to={'/edit/password'} disabled={submitting}>Change Password</Link>
				</div>
			</Form>
		);
	};
