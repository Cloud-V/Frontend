            ...
            <React.Fragment>
                <div className="app flex-column center-all h-100 landing-page">
                    ...
                    <div className="landing-section cloudv-slogan-subtext center-all-text">
                        <Col lg="12" md="10">
                            Cloud V is a research project that allows you to
                            design and test your chips online, free of charge.
                        </Col>
                    </div>
                    <div className="landing-section cloudv-button cloudv-create-try d-flex justify-content-center w-100">
                        ...
                        >
                            <Button
                                tag={Link}
                                to={"/try"}
                                className="action-button w-100 action-button-outline d-flex justify-content-center align-items-center"
                            >
                                Try Now
                            </Button>
                        </Col>
                    ...
                    <div className="landing-section landing-section-bottom cloudv-landing-footer d-flex flex-column align-items-center">
                        <Row className="landing-footer-text-wrap w-100 pt-2 center-all">
                            <Col md="4" sm="4" className="text-center">
                                <Link
                                    className="plain-link text-center no-decoration"
                                    to={"/privacy"}
                                >
                                    Privacy Policy
                                </Link>
                        ...
                        <Row className="landing-footer-sponsors w-100 pt-2 center-all">
                            <p className="text-center">
                                ...
                                <a
                                    ...
                                    className="plain-link  no-decoration"
                                >
