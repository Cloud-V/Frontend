...
class WaveformViewer extends Component {
    ...
    signalUp() {
        ...
        [renderedSignals[highlightIndex], renderedSignals[highlightIndex - 1]] =
            [
        ...
        return (
            <div className="waveform-toolbar">
                ...
                >
                    ...
                    >
                        {`Time: ${this.state.currentTime}${this.state.timeScaleUnit}`}
                    </MenuItem>
                </Menu>
            </div>
        );
                    ...
                    return (
                        <React.Fragment key={index}>
                            ...
                            <Rect
                                ...
                                onMouseMove={(evt) => {
                                    const pos =
                                        this.canvasRef.current.getPointerPosition();
                                    this.setState({
                                        hoverBoxX: pos.x,
                                        hoverBoxY: pos.y,
