...
class MenuBar extends Component {
    ...
    onMenuClicked({ key }) {
        ...
        switch (key) {
            ...
            case "knowledgebase": {
                return window.open(
                    "https://github.com/Cloud-V/Documentation/wiki"
                );
            }
            case "reportBug": {
                return window.open(
                    "https://github.com/Cloud-V/Issues/issues/new"
                );
            }
            default: {
                return true;
    ...
    renderMenu(menu) {
        ...
        const submenuClass = `menubar-submenu menubar-submenu-primary theme-${
