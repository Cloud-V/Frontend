...
import { contactUs, initContactUs } from "store/actions/contact";
...
const mapDispatchToProps = (dispatch) => {
    return {
        contactUs: ({ name, email, type, subject, content }) =>
            dispatch(
                contactUs({
                    name,
                    email,
    ...
    render() {
        ...
        return (
            <div className="app">
                <Navbar location={this.location} />
                <Container
                    className="flex-1 h-100 d-flex justify-content-center align-items-center"
                    fluid
                >
                    <Col
                        xl="4"
                    ...
                    >
                        ...
                        <div className="w-100 auth-box">
                            <p>
                                ...
                                <a href="mailto:cloudv@cloudv.io">
                                    cloudv@cloudv.io
                                </a>
                                .
                            </p>
                            <p>
                                For bug reports and feature requests, try
                                opening an issue on{" "}
                                <a
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    href="https://github.com/Cloud-V/Issues/issues/new"
                                >
                                    our GitHub page
                                </a>
                                .
                            ...
                            <p>
                                For other inquiries, contact principal
                                investigator Mohamed Shalan at{" "}
                                <a href="mailto:mshalan@aucegypt.edu">
