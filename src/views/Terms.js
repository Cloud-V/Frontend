...
import { getTerms } from "store/actions/terms";
    ...
    render() {
        ...
        return (
            <div className="app">
                <Navbar location={this.location} />
                <Container
                    className="terms flex-1 w-100 h-100 pl-0 pr-0 d-flex flex-column justify-content-center align-items-center"
                    fluid
                >
                    <div className="w-100 h-100 d-flex flex-column justify-content-center align-items-center">
                        <div className="terms-section terms-section-content w-75 mb-4 mt-4">
                            <ReactMarkdown
                                source={terms.get("data").get("terms")}
                            />
                        </div>
                    </div>
                </Container>
